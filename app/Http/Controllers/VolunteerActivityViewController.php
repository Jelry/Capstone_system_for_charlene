...
class VolunteerActivityViewController extends Controller
{
    public function index(Request $request, $id)
    {
        return view('volunteer.activity_view',[
            ...
            ->where('created_at','LIKE','%'."0".'%')->get(),'status'=>DB::table('activity_statuses')->where('acti_id','=',$id)->first(),'completed_event_photo' => DB::table('completed_event_photos')->get(),'user_email'=>Auth::user()->email
    ]);
    }
}
